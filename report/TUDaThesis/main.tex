...
\documentclass[
	ngerman,% Hauptsprache als globale Option, früher war ngerman notwendig
...
\pagenumbering{roman}
\Metadata{
	title=Multimodal Masked
Autoencoders for Non-Invasive
Physiological Signal
Reconstruction,
	author=Leqiao Peng
}

\title{ABC Multimodal Masked
Autoencoders for Non-Invasive
Physiological Signal
Reconstruction}
\subtitle{Multimodal Masked
Autoencoders for Non-Invasive
Physiological Signal
Reconstruction}
\author[L. Peng]{Leqiao Peng}%optionales Argument ist die Signatur,
%\birthplace{Geburtsort}%Geburtsort, bei Dissertationen zwingend notwendig
\reviewer{Dr.-Ing. (habil.) Stefan Göbel \and Tizian Dege, M.Sc., KIS*MED}%Gutachter
\studentID{1553297}
...
\input{makros.tex} %makros can be delete before submission
