"""Logging / metric tracking utilities.

``SmoothedValue`` tracks a running value with EMA-like smoothing across a
window plus global averages. ``MetricLogger`` wraps a data iterator and logs
matching MultiMAE / VideoMAE ``utils.py`` semantics.
"""
import time
import datetime
